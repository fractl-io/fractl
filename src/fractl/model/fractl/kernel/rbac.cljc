...
(defn-
 crud-list?
 [xs]
 (every? (fn* [p1__278#] (some #{p1__278#} oprs)) (set xs)))
(entity
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__279#] (str "'" (str p1__279#) "'")) role-names))
   "))")))
(dataflow
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__280#] (str "'" (str p1__280#) "'")) names))
   "))")))
(dataflow
...
(def
 ...
 "3b0e4e8d-ce4b-4901-b189-566cb88b55a9")
