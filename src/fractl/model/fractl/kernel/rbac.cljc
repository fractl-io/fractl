...
(defn-
 crud-list?
 [xs]
 (every? (fn* [p1__312#] (some #{p1__312#} oprs)) (set xs)))
(entity
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__313#] (str "'" (str p1__313#) "'")) role-names))
   "))")))
(dataflow
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__314#] (str "'" (str p1__314#) "'")) names))
   "))")))
(dataflow
...
(def
 ...
 "a4ac3104-0ee2-43b0-9e18-ab64cc779006")
